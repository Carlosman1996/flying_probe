...
class FlyingProbe:
    def __init__(self, inputs_path=None, pretest_path=None, outputs_path=None):
        ...
        self.engines_controller = engines_controller.EnginesController(serial_port="COM6",
                                                                       baud_rate=115200,
                                                                       devices_active=False)
        self.oscilloscope_controller = oscilloscope_controller.OscilloscopeController(device_active=False)
